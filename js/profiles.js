...
$( document ).ready(function() {
    ...
    $('.add-new-address').click(function(e){
       $(".bg-black-opacity").removeClass("hidden")
			 $(".popup-add-address").removeClass("hidden")
    })
    /* Update Address */
    ...
    /* Orders */
		$(".profiles-orders .tabs li").click(function(e){
		  $(".profiles-orders .tabs li").removeClass("active")
			$(this).addClass("active")
			let tab_id = $(this).attr("id")
			$("#order-item .tab").removeClass("active")
			$("#order-item ."+tab_id).addClass("active")
		})
});
